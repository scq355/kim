...
class Graph {
    ...
    public void addEdge(int source, int destination) {
        ...
        adjacencyMatrix[source][destination] = 1; // 无向图，设置为1
        adjacencyMatrix[destination][source] = 1; // 对称设置
    }
    ...
    public void removeEdge(int source, int destination) {
        ...
        adjacencyMatrix[source][destination] = 0; // 无向图，设置为0
        adjacencyMatrix[destination][source] = 0; // 对称设置
    }
